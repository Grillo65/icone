const NUMBER_OF_CLOUDS = 8; // clouds to show on screen
...
function createACloud() {
    ...
    image.src = "cloud_night/Private/images/cloud" + randomInteger(1, NUMBER_OF_IMAGES2) + ".png";
    cloudDiv.style.top = pixelValue(randomInteger(-2, 8));
    // cloudDiv.style.left = pixelValue(randomInteger(-400, -100));
